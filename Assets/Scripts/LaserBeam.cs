...
public class LaserBeam
{
    ...
    void CheckHit(RaycastHit hitInfo, Vector3 direction, LineRenderer laser)
    {
        ...
        else if(hitInfo.collider.gameObject.tag == "Refract")
        {
            ...
            Vector3 newPos1 = new Vector3(Mathf.Abs(direction.x)/(direction.x+ 0.00001f) *0.0001f + pos.x,
                    Mathf.Abs(direction.y)/(direction.y+ 0.00001f) *0.0001f + pos.y,
                    Mathf.Abs(direction.z)/(direction.z+ 0.00001f) *0.0001f + pos.z);
